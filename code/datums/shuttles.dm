...
/datum/map_template/shuttle/emergency/govno
	suffix = "govno"
	name = "A Totally Shitty Shuttle"
	description = "Builded by Boyarka Federation Russian engineers."
	admin_notes = "just4lulz"
	credit_cost = -3000
